...
1. If you are completely new to Java, then directly jumping into Spring Boot is NOT recommended.
2. First, learn Core Java and get familiar with the Java ecosystem.
...
Once you got it working, you may have to go back and explore further how Spring Boot auto-configuration makes it work.
{{< /box >}}
...
* **Build a basic CRUD REST API:** Create a basic REST API performing CRUD(Create, Read, Update, Delete) operations using a HashMap based storage.
  The goals of this exercise are:
    ...
    * Understand how to use **@PathVariable, @RequestBody** to work with URL path variables and HTTP request body.
...
Again, Spring Boot makes it very straightforward to use those database migration tools with its auto-configuration support.
...
I hope these resources and guidelines help you to learn Spring Boot.
