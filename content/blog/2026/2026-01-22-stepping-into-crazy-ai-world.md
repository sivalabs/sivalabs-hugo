...
will be written by AI, YouTubers who became AI Experts overnight tell you that "AI will take over the world by 2030".
And then suddenly, you come across a Tweet or a LinkedIn post saying AI is not yet good enough for the real world projects.
...
Based on what I read/heard from various sources, none of the AI companies are making any profits as of now.
And there are rumors that if they can't figure out a way to make money in a few years, then it's going to be an economic disaster.
But I think there is no going back now. So, it is best to accept the new reality and adapt to it.
...
* Learn how to configure the guidelines using [AGENTS.md](https://agents.md/), **CLAUDE.md**, **GEMINI.md**, etc to instruct the AI agents about how to work with the project
* Learn how to use [Agent Skills](https://agentskills.io/) to tune AI Agents generate code according to your preference
...
* Learn how to use AI tools integrated with IDEs like IntelliJ IDEA leveraging the integrated [AI capabilities](https://www.jetbrains.com/ai/) using [Junie](https://www.jetbrains.com/junie/), [ACP](https://blog.jetbrains.com/ai/2025/12/bring-your-own-ai-agent-to-jetbrains-ides/), etc 

## Spec Driven Development
The latest silver bullet in the age of AI is the Spec Driven Development (SDD). 
In SDD, the main focus is on writing clear and concise specifications that define the desired behavior of the software. 
The AI agents can be used to generate code based on these specifications, ensuring that the code meets the required standards and functionality.
...
{{< figure src="/images/ai-powered-swe.webp" alt="AI powered Software Development" >}}

## Conclusion
As I mentioned, these are not normal times. The world is changing at an unprecedented pace to catch up.
So, don't be too hard on yourself thinking only you are not able to keep up with the pace. 
