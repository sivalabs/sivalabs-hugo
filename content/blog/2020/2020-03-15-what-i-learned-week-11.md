...
Also, in day-to-day work I learn a few new things, explore some new tools. 
...
We can use [p6spy-spring-boot-starter](https://github.com/gavlyukovskiy/spring-boot-data-source-decorator) to log the generated SQL statements with actual parameters.
...
* You might have heard about **Hexagonal Architecture** and are wondering how to implement it using Spring, then this article is for you:
...
* If you don't like **Setters and Getters** but you are using them just because of JSON to Object marshalling, then this is for you:
