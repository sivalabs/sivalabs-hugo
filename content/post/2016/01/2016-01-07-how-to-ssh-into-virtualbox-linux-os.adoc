...
date: 2016-01-07T09:00:00+05:30
Section: post
tags: ["Linux","VirtualBox"]
categories: ["Linux"]
Description: "While learning some of the Linux commands we may want to use SSH commands to login into a remote Linux system 
and we may not have a dedicated Linux system to play with. In this post I will explain how I am using my Linux OS installed 
on VirtualBox to SSH from Windows OS."
draft: false
---

include::data/ascii-settings.txt[]

While learning some of the Linux commands we may want to use SSH commands to login into a remote Linux system 
and we may not have a dedicated Linux system to play with.
