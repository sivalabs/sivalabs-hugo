...
Section: post
Description: "Once the Admin User clicked on Password Reset Link that we sent via Email, we will validate the Token 
	and if is valid then we will show a form to enter New Password, otherwise shows an error."
      ...
      RedirectAttributes redirectAttributes)
    {
     try
     {
         ...
         if(!password.equals(confPassword))
         {
              ...
              getMessage(ERROR_PASSWORD_CONF_PASSWORD_MISMATCH));
              return "public/resetPwd";
         }
